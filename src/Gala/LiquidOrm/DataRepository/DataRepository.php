...
use Gala\LiquidOrm\DataMapper\Exception\DataMapperInvalidArgumentException;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    {
        if (empty($id)) {
            throw new DataMapperInvalidArgumentException("Argument must not be empty");
        }
    }
    ...
    public function findBy(array $selectors = [], array $conditions = [], array $parameters = [], $optional = []): array
    {
        try {
